...
# Note: PreprocessingConfig is defined in core.document_processing.processors.preprocessing
# Import is removed to avoid circular dependency
...
class PreprocessingSettings(BaseModel):
    ...
    def to_preprocessing_config(self):
        """Convert to PreprocessingConfig object."""
        # Import here to avoid circular dependency
        from core.document_processing.processors.preprocessing import PreprocessingConfig
